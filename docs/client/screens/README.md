# Экраны приложения Easy English

[Docs](../../README.md) → [Client](../README.md) → **Screens**

Описание каждого экрана вынесено в отдельный файл. Общая навигация и флоу — в [Product: design-flows](../../product/design-flows.md). Продуктовый контекст — [Product: PRD](../../product/PRD.md).
